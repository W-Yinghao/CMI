#!/bin/bash
#SBATCH --job-name=cigl-p3aj-bnci001
#SBATCH --partition=A100,V100,V100-32GB,A40
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=32G
#SBATCH --output=logs/cigl/cigl-p3aj-bnci001-%j.out
#SBATCH --error=logs/cigl/cigl-p3aj-bnci001-%j.out
...
# Real Phase 3A-J run: FIXED erm_fixed + graph_node_010, folds 0-8, full seeds/epochs/n_perm (NO reduction).
"$PY" scripts/run_cigl_phase3a_dgcnn_gn_multifold_confirmation.py \
