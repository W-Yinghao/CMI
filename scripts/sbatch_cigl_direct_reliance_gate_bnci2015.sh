#!/bin/bash
#SBATCH --job-name=dcigl-gate-bnci2015
#SBATCH --partition=A100,V100,V100-32GB,A40
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=32G
#SBATCH --output=logs/cigl/dcigl-gate-bnci2015-%j.out
#SBATCH --error=logs/cigl/dcigl-gate-bnci2015-%j.out
set -euo pipefail
...
"$PY" scripts/run_cigl_direct_reliance_gate.py --dataset BNCI2015_001 --device cuda --seed "${GATE_SEED:-0}" \
