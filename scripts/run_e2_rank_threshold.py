...
def main():
    ...
    if args.probe:
        ...
        qc = {
            ...
            "logit_change_remove_SD_relative": round(rec["logit_change_remove_SD_relative"], 4),
            "k_star_linear_removal": rec["k_star_linear_removal"],
            "k_star_ge_r_D": rec["k_star_ge_r_D"],
