...
\item \textbf{EEGNet dim/type confound.} TSMNet and EEGNet differ in \emph{both} architecture and latent dimension
  (210 vs 16), which are collinear here. We establish that low-rank removability is representation-dependent
  and capacity-mediated, but do \textbf{not} isolate the causal factor (convolutional inductive bias vs latent
