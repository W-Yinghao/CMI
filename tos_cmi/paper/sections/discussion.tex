...
\item \textbf{Dimension-vs-type: tested, capacity-mediated.} The original two-point comparison confounded
  ...
  \emph{dimension}, with SPD and convolutional latents nearly coinciding at matched $d_z$ --- the contrast
  is capacity-mediated, not representation-type. Remaining caveats on this factorial: a single dataset
