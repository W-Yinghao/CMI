...
We evaluate on BCI-IV-2a (BNCI2014\_001) \cite{brunner2008bci}, loaded via the MOABB pipeline
\cite{jayaram2018moabb}, under leave-one-subject-out (LOSO), domain = subject. For each
...
accuracy. We compare two representations to test generality: TSMNet \cite{kobler2022spd} (LogEig/SPD tangent
latent, $d_z=210$) and EEGNet \cite{lawhern2018eegnet} (convolutional penultimate latent, $d_z=16$). As the standard baseline for ``global'' conditional
