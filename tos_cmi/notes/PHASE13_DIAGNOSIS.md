...
- `probe_ucb` rises monotonically toward Bayes Δ* with BOTH n and capacity → the residual nested
  critic is a **consistent** estimator of the synergy (structural-blindness hypothesis REFUTED).
