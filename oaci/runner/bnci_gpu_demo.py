...
def build_gpu_report(result) -> dict:
    ...
    return {
        ...
        "git_commit": result.canonical.context.git.commit, "git_tree_hash": result.canonical.context.git.tree_hash,
        "provenance_hash": result.canonical.write_result.provenance_hash,
        ...
        "canonical_artifact": {"dir": result.canonical.write_result.artifact_dir,
                               ...
                               "artifact_pure_science_hash": result.canonical.write_result.artifact_pure_science_hash,
        ...
        "reversed_artifact": {"dir": result.reversed.write_result.artifact_dir,
                              ...
                              "artifact_pure_science_hash": result.reversed.write_result.artifact_pure_science_hash,
