...
test_sample_mass test_backbone test_real_data_blockers test_bnci_loader test_bnci_runner_adapter test_cuda_runtime test_bnci_gpu_compare test_bnci_gpu_script test_confirmatory_adapter test_confirmatory_report test_confirmatory_staged"
