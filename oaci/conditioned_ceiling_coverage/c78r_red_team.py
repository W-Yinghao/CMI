...
def run() -> list[dict[str, Any]]:
    ...
    repairs = [
        ...
        {"item": "R4_storage_fixed_overhead", "finding": "fixed overhead is not independently identified from prior layout", "resolution": "storage projection is per-unit with 25% safety envelope and disclosed as planning, not measured full-field cost"},
