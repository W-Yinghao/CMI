...
def finalize() -> dict:
    ...
    payload = {
        ...
        "verification": {
            "focused_C75": {"passed": 17},
            "C65_C75": {"passed": 97, "slurm_job": "final_rerun"},
            "C23_C75": {"passed": 504, "slurm_job": "final_rerun"},
            "full_OACI": {"passed": 1432, "slurm_job": "final_rerun"},
    ...
    lines = [
        ...
        "- C65-C75 regression: `97 passed` (final Slurm rerun).",
        "- C23-C75 regression: `504 passed` (final Slurm rerun).",
        "- full OACI suite: `1432 passed` (final Slurm rerun).",
