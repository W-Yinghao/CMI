#!/usr/bin/env bash
#SBATCH --job-name=c78r-aggregate
...
export PYTHONPYCACHEPREFIX="/tmp/c78r-aggregate-pycache-${SLURM_JOB_ID}"
export OMP_NUM_THREADS=1 MKL_NUM_THREADS=1 OPENBLAS_NUM_THREADS=1 NUMEXPR_NUM_THREADS=1
/home/infres/yinwang/anaconda3/envs/icml/bin/python \
  -m oaci.conditioned_ceiling_coverage.c78r_instrument aggregate \
