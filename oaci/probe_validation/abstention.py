...
def availability(val_rows) -> dict:
    ...
    g = estimability_gate.gate_summary(val_rows, robust, list(c19.ENDPOINT_FEATURES))
    return {"n_candidates": g["n_candidates"], "robust_core_scored_rate": g["scored_rate"],
            "robust_core_insufficient_rate": g["insufficient_finite_rate"],
            "endpoint_nonestimable_rate": g["endpoint_nonestimable_rate"], "counts": g["counts"]}
