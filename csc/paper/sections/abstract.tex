\begin{abstract}
We study \emph{when} a concept shift --- a change in the class posterior $P(Y\mid Z)$ of an EEG
representation --- can be \emph{certified}, and when a method must instead abstain. We first prove that
...
informed-selection/generalization gap. \textbf{Route B3} adds the minimal information that Prop.~\ref{prop:impossible}
shows is required: a \emph{paired within-subject} target-internal reference (each subject's own
