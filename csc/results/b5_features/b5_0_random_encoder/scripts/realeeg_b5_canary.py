...
B5_CACHE = os.path.join(FEAS, "b5_features/b5_0_random_encoder/LEE2019_B5_0.npz")
B5_MANIFEST = os.path.join(FEAS, "b5_features/b5_0_random_encoder/b5_0_feature_manifest.json")
FEATURE_FAMILY = "B5_0_random_eegnet"
