...
| **Task retained** under the regularizer | CIGL_29 (src drop ≤0.02 primary folds), CIGL_31 (src retained 11/12; target guardrail 12/12) | "without harming source-task performance (drop ≤0.02 in most folds)" | "improves accuracy"; "no cost ever"; ignore fold9 miss | WORDING |
