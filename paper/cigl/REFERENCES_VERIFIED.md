# CIGL References (Phase 4C — verification status)

> Verified from reviewer-provided sources / standard records. Any uncertain field is marked **TODO: verify**
> (exact pages/DOI to confirm before final BibTeX). **No BibTeX is finalized here** — this is a verification
> ledger, not a `.bib`.
...
| dgcnn_song | Song, Zheng, et al. | EEG Emotion Recognition Using Dynamical Graph Convolutional Neural Networks | IEEE (emotion; DGCNN) | title/method verified; **TODO: verify** exact venue (IEEE Trans. Affective Computing?)/year/DOI |
