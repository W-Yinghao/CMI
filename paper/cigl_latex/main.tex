% CIGL manuscript — LaTeX-ready draft (Phase 4F / v0.4).
...
% Visible marker for citations whose exact bibliographic fields are not yet verified
% (entry identity exists in REFERENCES_DRAFT.bib; venue/DOI/pages may still be % TODO there).
\newcommand{\todoverify}{\textbf{[TODO: verify citation]}}
...
\date{Draft v0.4 / Phase 4F --- not for submission}
