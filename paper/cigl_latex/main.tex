...
% CMI-Trace title-decision logic (P0.3): the printed title is UNCHANGED here. The CMI-Trace revision
% RETAINS the broader "what domain-invariance objectives remove" scope ONLY IF the P0.1 same-backbone
% objective comparison completes (all four DG families run on the same static-adjacency DGCNN adapter --
% jobs 896396 BNCI2014_001, 896397 BNCI2015_001, currently producing). If P0.1 CANNOT be completed, NARROW
% the title/claims to encoder-CMI measurement + functional limits (drop the cross-objective framing).
% Do NOT change the printed title text until completeness_matrix.csv shows all cells present.
...
\input{sections/06_analysis_negative_results}
