# Step 13 — retrospective offline-TTA harm predictor
...
- runs: **54** · harm-rate **0.8519** · majority-baseline balanced-acc **0.5** · minority-class n **8** (frac 0.1481, imbalance-warning True) · n_perm 100
